...
//  몇일이 지났는지
const prevDate = new Date( date.getFullYear(), 0, 1 ); //올해1월1일
const ts2 = prevDate.getTime();
const tmp1 = ts1 - ts2;     //  1970.1.1~현재 - 1970.1.1~2024.1.1 => 2024.1.1~현재
console.log(tmp1);
//  24시간 * 60분 * 60초 * 1000
...
const ts3 = nextDay.getTime();      //  2024.12.31
const tmp2 = ts3-ts1;           //  1970.1.1~2024.12.31 - 1970.1.1~현재 => 현재~2024.12.31
...
today.setDate(1);       //  이번달 1일 -> today
const startDay = today.getDay();    //  startDay <- 이번달 1일 요일의 인덱스
//  이번달 1일에 대한 요일 인덱스
